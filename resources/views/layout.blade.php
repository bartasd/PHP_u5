...
<head>
    ...
    <title>U5 BANK</title>
    @vite(['resources/css/app.scss', 'resources/css/form.scss', 'resources/css/font-awesome.min.css', 'resources/js/jquery-3.6.0.min.js', 'resources/css/workField.scss', 'resources/js/app.js'])
...
<body>
    ...
    <div class="nav">
        ...
        <a href="{{ route('clients-accounts') }}"
            class="{{ Request::routeIs('clients-accounts') || Request::routeIs('clients-accounts.index') ? 'active activeLara' : '' }}"><i
